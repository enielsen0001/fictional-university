    ...
    <div class="container">
        ...
        <div class="site-header__menu group">
            ...
            <div class="site-header__util">
                <a href=<?php echo site_url('/login') ?> class="btn btn--small btn--orange float-left
                   push-right">Login</a>
                <a href=<?php echo site_url('/sign-up') ?> class="btn btn--small btn--dark-orange float-left">Sign
                Up</a>
